...
D. Devolver la constante π. La constante matemática π = 3.141592…, hasta la precisión disponible de Math.
...
int main()
{
    ...
    cout << "D. Devolver la constante π. La constante matemática π = 3.141592…, hasta la precisión disponible de Math." << endl;
    ...
    case 'D':
    case 'd':
        cout << "La constante π es: " << M_PI << endl;
        break;
    case 'E':
    case 'e':
