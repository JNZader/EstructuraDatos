...
int main()
{
	...
	while (continuar)
	{
		...
		std::cout << "1. Multiplicación por sumas sucesivas" << std::endl;
		std::cout << "2. División por restas sucesivas" << std::endl;
		...
		{
		case 1:
			std::cout << "Ingrese dos números para la multiplicación (a b): ";
			std::cin >> a >> b;
			std::cout << "Resultado: " << multiplicacionPorSumas(a, b) << std::endl;
			break;
		case 2:
			std::cout << "Ingrese dos números para la división (a b): ";
			std::cin >> a >> b;
